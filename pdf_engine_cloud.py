...
class PDF(FPDF):
    def __init__(self, *args, **kwargs):
        ...
        # fontes (coloque DejaVuSans.ttf e DejaVuSans-Bold.ttf na raiz do projeto)
        try:
...
def gerar_pdf_pro(
    ...
    # CAPA
    pdf.add_page()
    pdf.set_font(FONTE_PADRAO, 'B', 20)
    ...
    # GRÁFICOS PRINCIPAIS (vindos do layout.py)
    if figs_principais:
